...
namespace CollectionsProject
{
    class ManageMovies
    {
        ...
        {
            //List<KeyValuePair<int, Movie>> list = new List<KeyValuePair<int, Movie>>;
            List<KeyValuePair<int, Movie>> Dict_movie = movies.ToList();
            return Dict_movie.FindIndex(m => m.Key == id);//Lambda expression
        }
